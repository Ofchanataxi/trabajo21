...
@Component({
  selector: "app-approved-by-quality",
  templateUrl: "./approved-by-quality.component.html",
  styleUrls: ["./approved-by-quality.component.scss"],
})
export class ApprovedByQualityComponent {
  items: any[] = [];
