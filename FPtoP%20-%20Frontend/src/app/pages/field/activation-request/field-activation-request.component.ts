...
@Component({
  selector: "app-field-activation-request",
  templateUrl: "./field-activation-request.component.html",
  styleUrls: ["./field-activation-request.component.scss"],
})
export class FieldActivationRequestComponent {
  items: any[] = [];
